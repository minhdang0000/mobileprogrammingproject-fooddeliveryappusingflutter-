...
import 'package:project_food_delivery/base/no_data_page.dart';
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          GetBuilder<CartController>(builder: (_cartController){
            return _cartController.getIems.length>0?Positioned(
                ...
                child: Container(
                    ...
                    child: MediaQuery.removePadding(
                      ...
                      child: GetBuilder<CartController>(builder: (cartController){
                        var _cartList = cartController.getIems;
                                  ...
                                  children: [
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                fit: BoxFit.cover,
                                                image: NetworkImage(
                                                    AppConstants.BASE_URL+AppConstants.UPLOAD_URL+cartController.getIems[index].img!
                                                )
                                            ),
                                    ...
                                    Expanded(child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          BigText(text: cartController.getIems[index].name!, color: Colors.black54,),
                                          SmallText(text: "Spicy",),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              BigText(text: cartController.getIems[index].price.toString(), color: Colors.redAccent,),
                                              Container(
      ...
      bottomNavigationBar: GetBuilder<CartController>(builder: (cartController){
        return Container(
          ...
          child: cartController.getIems.length>0?Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Container(
